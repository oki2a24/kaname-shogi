...
3. 「駒取りと持ち駒の基礎」の第1問への本人の回答を待ち、回答と補足を記録する。
...
次の学習テーマは「駒取りと持ち駒の基礎」とした。日本将棋連盟の一次資料で、相手駒のある所へ進むとその駒を取れ、取った駒を持ち駒ということ、持ち駒は原則として空いている所へ打てることを確認した。今回の第1問は、盤上の相手の歩を取った直後の駒と持ち駒の状態を問うものであり、本人の回答待ちである。設計の合意やコード変更はまだ行っていない。
...
第24回の実装後理解確認まで完了しています。次のテーマ「駒取りと持ち駒の基礎」は、一次資料の確認と第1問の出題まで済んでおり、本人の回答待ちです。確認問題は一問ずつ出し、回答と振り返りを記録してから設計・実装へ進んでください。
