...
- [ ] **ステップ2: 独立コードレビューを実施する**

仕様書、実装、テスト、`git diff` を実装時の判断から独立して確認する。Critical・Important・Minorを分類し、Critical・Importantがあれば修正、対象・全体検証、再レビューを行う。Minorは採否と理由を記録する。

- [ ] **ステップ3: 学習記録と知識メモを作成・更新する**
